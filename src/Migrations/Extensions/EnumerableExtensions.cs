namespace AlbedoTeam.Sdk.DataLayerAccess.Migrations.Extensions
{
    using System;
    ...
    internal static class EnumerableExtensions
    {
        ...
        internal static IEnumerable<TMigrationType> CheckForDuplicates<TMigrationType>(
            this IEnumerable<TMigrationType> list)
            where TMigrationType : class, IMigration
        {
            var uniqueHashes = new HashSet<string>();
            var checkForDuplicates = list.ToList();
            foreach (var element in checkForDuplicates)
            {
